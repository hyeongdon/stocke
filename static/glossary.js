...
const GLOSSARY = [
  {
    ...
    items: [
      ...
      { t: '15/92 홀드 (ma1592)', tags: 'MA1592 1592매매 EMA15 EMA92', d: 'HTS 1592매매 편입 관찰 후 3분봉 EMA15>EMA92(GC)로 15%→35%→50% 분할 매수. 전고 50% 익절. 시세 전 청산은 급락+DC, 시세 후는 급락+92선이탈. 하드이탈%는 수량 계산만.' },
  ...
  },
  {
    ...
    items: [
      ...
      { t: '급락% (15/92)', tags: 'ma1592_crash_pct STOP_MA_DC_CRASH STOP_MA_CRASH', d: '최근고점 대비 하락%. 고점 이후 3봉(crash_bars) 이내여야 함. 급락만으로는 안 팔고, 시세 전은 EMA15≤EMA92(DC), 시세 후는 92선이탈과 같이 봐야 청산.', f: '(고점−종가)/고점 ≥ 급락%' },
      { t: '92선이탈% (15/92)', tags: 'ma1592_large_break_pct STOP_MA_CRASH', d: '시세 후 잔량 청산. 종가가 EMA92를 이 % 이상 하향 + 급락이면 STOP_MA_CRASH(급락+큰이탈).', f: '종가 < EMA92×(1−92선이탈%)' },
