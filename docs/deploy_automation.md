...
기본 배치는 **서버 TZ=UTC** 기준으로 등록합니다(의도 시각은 KST). 평일 06:42 UTC(15:42 KST) 매수 실패 신호, 10:50 UTC(19:50 KST) 키움 손익 동기화, 10:52 UTC(19:52 KST) 매매 일지, 매일 09:00 UTC(18:00 KST) 기본적분석 마트, 09:30 UTC(18:30 KST) 테마 마트(동시 실행 OOM 방지), 매월 16일 01:00 UTC(10:00 KST) 업종 배치입니다. `crontab -l`과 `timedatectl`로 확인하세요.
